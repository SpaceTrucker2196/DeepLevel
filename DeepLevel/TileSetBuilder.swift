...
final class TileSetBuilder {
    ...
    static func build(tileSize: CGFloat) -> (SKTileSet, TileRefs) {
        ...
        // City Map textures
        let parkTexture      = SKTexture(imageNamed: "Park")
        let residential1Tex  = SKTexture(imageNamed: "Residential1")
        let residential2Tex  = SKTexture(imageNamed: "Residential2")
        let residential3Tex  = SKTexture(imageNamed: "Residential3")
        let residential4Tex  = SKTexture(imageNamed: "Residential4")
        let urban1Tex        = SKTexture(imageNamed: "Urban1")
